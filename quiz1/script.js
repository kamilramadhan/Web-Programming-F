...
window.addEventListener('scroll', () => {
    ...
    depan1.style.top = value * -0.2 + 'px';
    depan2.style.top = value * -0.2 + 'px';
    belakang4.style.top = value * -0.2 + 'px';
    rektorat5.style.top = value * -0.2 + 'px';
    belakang4.style.left = value * -0.15 + 'px';
